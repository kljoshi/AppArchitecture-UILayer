...
Finally, you increased your knowledge of data binding by learning how to make your data binding lifecycle-aware, and how to bind XML layouts to LiveData objects. Thus, making layouts that are automatically updated when LiveData changes. One thing that you might have noticed is that you moved around a lot of code over to the ViewModel. 

In larger apps, you want to make sure that your VieModel doesn’t take on too much responsibility and become bloated like your game fragment was. We’re going to further refine the role of the ViewModel in future lessons and add additional classes to this architecture. 
